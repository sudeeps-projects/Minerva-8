...
MINERVA-8 (CUSTOM 8-BIT ASSEMBLER) is a console-based 8-bit CPU simulator written in C++ that demonstrates how a processor executes instructions through the fetch-decode-execute cycle while showing changes to registers, memory, flags, and control flow.
...
## Why did I do this
I took a class in C++ in 10th grade. I was not able to follow the professor's teachings when he said C++ will be converted to Assembly language
